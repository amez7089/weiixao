...
def main():
    ...
    # 3.3 创建一个窗口 图形界面
    playSurface = pygame.display.set_mode((1000, 700))
    ...
    while True:
        ...
        print i
        if targetflag == 0:
            x = random.randrange(1,32) # 屏幕640 480    20
        ...
        if snakePosition[0] > 1000 or snakePosition[0] < 0:
             ...
             gameOver()
        # elif  snakePosition['x'] == snake_coords[HEAD]['x'] and snakeBody['y'] == snake_coords[HEAD]['y']:
        #     gameOver()
        # 控制游戏速度
        if i%4==0:
            i=i+1
